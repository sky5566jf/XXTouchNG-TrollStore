...
CHConstructor {
    @autoreleasepool {
        ...
        {
            // Hook functions using ellekit instead of Substrate
            // Note: For TrollStore, these hooks may need alternative approaches
            CHDebugLogSource(@"%@ - hook setup deferred for TrollStore", processName);
